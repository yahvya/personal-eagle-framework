...
class BinaryColumn extends TableColumn
{
     ...
     * @param int $maxLen Field max length
     * @param bool $isNullable If the field is nullable (set to false by default or if it is a primary key)
