...
use Yahvya\EagleFramework\Database\Default\CustomDatatypes\Timestamp;
use Yahvya\EagleFramework\Database\Default\Formater\Formater;

/**
 * @brief Timestamp|date|time column type
 */
#[Attribute]
class TimestampColumn extends TableColumn
{
    ...
    #[Override]
    public function convertToValue(mixed $data): Timestamp
    {
        return Timestamp::fromDatabase(data: $data);
    }

    /**
     * @param Timestamp $data Attribute data
     * @return mixed Converted timestamp
     */
    #[Override]
    public function convertFromValue(mixed $data): int
    {
